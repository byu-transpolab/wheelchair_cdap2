...
\begin{itemize}
 \item Full-time workers (FW) - reported working "full-time" at their primary job.
 \item Part-time worker (PW) - reported working "part-time" at their primary job,
 as well as any person who reported being a "non-worker" or "retired" who nevertheless
 reported a work or school activity.
 \item Non-working adults (NW) - reported "unemployed" as their primary activity
 of the previous week, as well as individuals over 18 who were not classified
 elsewhere.
 \item Retired (RT) - reported "retired" as their primary activity of the 
 previous week, or who are over the age of 65 and reported that they were not
 workers.
 \end{itemize}
...
<!--- This table contains the number of each dap for each person type
how should it get referrenced?--->
Table \ref{tab:dap} 
shows the observed distribution of daily activity patterns
within each person segment.
