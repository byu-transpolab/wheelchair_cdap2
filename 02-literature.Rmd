...
A number of recent studies have also looked at the role of developmental \cite{Wasfi2007}
and intellectual \cite{Feeley2019} disabilities on travel patterns. However,
...
in the U.S., of whom 20 percent (or 2.7 million) use wheelchairs \cite{Brumbaugh2018}.
...
<!--do the citations need to be in order? this one is (11, 2) for example
I wont change any, just wondering-->
in the coming years with the relative aging of the U.S. population \cite{Sweeney2004, Laplante2003}.
...
days if ever \cite{Sweeney2004}, make fewer daily trips 
\cite{Schmocker2005, Brumbaugh2018}, make fewer work trips and more
healthcare maintenance trips \cite{Ermagun2016}, rely more on others for their travel \cite{Sweeney2004},
and have considerably restricted mode
choices \cite{Rosenbloom2007, Ruvolo2020}. These differences in mobility and activity patterns
have important and observed negative implications for the individual's access to
opportunity for employment \cite{Rosenbloom2007, Lubin2012} and social interaction
\cite{Bascom2017, Velho2016}.
...
\cite{VanRoosmalen2010}, poorly maintained sidewalk and pedestrian infrastructure
\cite{frackelton2013measuring},  lack of physical access to TNC
vehicles \cite{Ruvolo2020}, bus ramp complication and malfunction \cite{Velho2016},
...
to travel backwards in the wheelchair priority area \cite{Velho2016}, or 
suffering outright discrimination from TNC operators \cite{Bascom2017}.
...
Berlin, Bischoff \cite{Bischoff2019} simply assumed demand for this service
